...
std::istream& BigInteger<2>::read(std::istream& in) {
  in >> *this;
  return in;
}
...
template BigInteger<8> BigInteger<8>::operator*(const BigInteger<8>&) const;
template BigInteger<8> BigInteger<8>::operator%(const BigInteger<8>&) const;
template BigInteger<8>::operator BigUnsigned<8>() const;
template BigInteger<8>::operator BigInteger<8>() const;
template BigInteger<8>::operator BigRational<8>() const;
...
template BigInteger<10> BigInteger<10>::operator*(const BigInteger<10>&) const;
template BigInteger<10> BigInteger<10>::operator%(const BigInteger<10>&) const;
template BigInteger<10>::operator BigUnsigned<10>() const;
template BigInteger<10>::operator BigInteger<10>() const;
template BigInteger<10>::operator BigRational<10>() const;
...
template BigInteger<16> BigInteger<16>::operator*(const BigInteger<16>&) const;
template BigInteger<16> BigInteger<16>::operator%(const BigInteger<16>&) const;
template BigInteger<16>::operator BigUnsigned<16>() const;
template BigInteger<16>::operator BigInteger<16>() const;
template BigInteger<16>::operator BigRational<16>() const;
